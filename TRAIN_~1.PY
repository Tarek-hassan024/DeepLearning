...
if __name__ == '__main__':
    ...
    save_network = 'Trained_GM_LAMP_for_SV_'+ type +'_'+ MN + SNRrange +'_'+ vSNRrange + '_K='+str(K) + '.npz'
    ...
    layers, y_ = define_networks.build_LAMP(A, T=T, shrink=shrink, untied=True, K=K)
